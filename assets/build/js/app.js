...
function work_amount_calculation(weight) {
  ...
  result_work.appendChild(document.createTextNode('G smb rp = ' + Math.round(smrp)))
...
function base_amount_calculation (age, weight, type) {
  ...
  if (age < 3) {
    ...
    result_need.appendChild(document.createTextNode('G smb rp = ' + Math.round(smrp)))
...
function feed_calculation() {
  ...
  let result_smrp = (parseFloat(total_given_smrp) - parseFloat(total_needed_smrp));

  result_feed.appendChild(document.createTextNode('Tilldelat MJ: ' +  result_mj))
  result_feed.appendChild(document.createElement('br'))
  result_feed.appendChild(document.createTextNode('Tilldelat g smb rp: ' +  result_smrp))
  result_feed.appendChild(document.createElement('br'))
...
function hay_calculation() {
  ...
  //   result_feed.appendChild(document.createTextNode(element))
  //   result_feed.appendChild(document.createElement('br'))
